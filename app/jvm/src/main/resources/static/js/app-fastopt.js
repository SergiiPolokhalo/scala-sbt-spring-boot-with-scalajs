...
/** @constructor */
function $c_Lmikemcgowan_App$() {
  $c_O.call(this);
  this.upTo$1 = 0
}
$c_Lmikemcgowan_App$.prototype = new $h_O();
$c_Lmikemcgowan_App$.prototype.constructor = $c_Lmikemcgowan_App$;
/** @constructor */
function $h_Lmikemcgowan_App$() {
  /*<skip>*/
}
$h_Lmikemcgowan_App$.prototype = $c_Lmikemcgowan_App$.prototype;
$c_Lmikemcgowan_App$.prototype.init___ = (function() {
  this.upTo$1 = 10;
  return this
});
$c_Lmikemcgowan_App$.prototype.run__V = (function() {
  var hello = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("hello");
  var this$4 = new $c_sci_StringOps().init___T("Hello from Scala.js! Primes up to %d are:");
  var array = [this.upTo$1];
  ...
  hello.textContent = jsx$2.format__T__AO__T($$this, result);
  var primes = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("primes");
  var this$18 = $m_Lmikemcgowan_Sieve$().primes__I__sci_List(this.upTo$1);
  primes.textContent = $f_sc_TraversableOnce__mkString__T__T__T__T(this$18, "", ", ", "");
  this.upTo$1 = ((this.upTo$1 >= 100) ? 10 : ((10 + this.upTo$1) | 0))
});
$c_Lmikemcgowan_App$.prototype.append__T__T__Lorg_scalajs_dom_raw_Element__V = (function(tag, id, target) {
  var child = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement(tag);
  child.setAttribute("id", id);
  target.appendChild(child)
});
$c_Lmikemcgowan_App$.prototype.main__AT__V = (function(args) {
  var container = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementsByClassName("container")[0];
  this.append__T__T__Lorg_scalajs_dom_raw_Element__V("p", "hello", container);
  this.append__T__T__Lorg_scalajs_dom_raw_Element__V("code", "primes", container);
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().setInterval((function() {
    $m_Lmikemcgowan_App$().run__V()
  }), 2000.0);
  this.run__V()
});
var $d_Lmikemcgowan_App$ = new $TypeData().initClass({
  Lmikemcgowan_App$: 0
}, false, "mikemcgowan.App$", {
  Lmikemcgowan_App$: 1,
  O: 1
});
$c_Lmikemcgowan_App$.prototype.$classData = $d_Lmikemcgowan_App$;
var $n_Lmikemcgowan_App$ = (void 0);
function $m_Lmikemcgowan_App$() {
  if ((!$n_Lmikemcgowan_App$)) {
    $n_Lmikemcgowan_App$ = new $c_Lmikemcgowan_App$().init___()
  };
  return $n_Lmikemcgowan_App$
}
/** @constructor */
function $c_Lmikemcgowan_Sieve$() {
  $c_O.call(this)
}
$c_Lmikemcgowan_Sieve$.prototype = new $h_O();
$c_Lmikemcgowan_Sieve$.prototype.constructor = $c_Lmikemcgowan_Sieve$;
/** @constructor */
function $h_Lmikemcgowan_Sieve$() {
  /*<skip>*/
}
$h_Lmikemcgowan_Sieve$.prototype = $c_Lmikemcgowan_Sieve$.prototype;
$c_Lmikemcgowan_Sieve$.prototype.init___ = (function() {
  return this
});
$c_Lmikemcgowan_Sieve$.prototype.primes__I__sci_List = (function(n) {
  if ((n < 2)) {
    return $m_sci_Nil$()
  } else {
    var this$6 = new $c_sci_Range$Inclusive().init___I__I__I(2, n, 1);
    $m_sci_List$();
    var b = new $c_scm_ListBuffer().init___();
    var i = 0;
    while ((i < n)) {
      b.$$plus$eq__O__scm_ListBuffer(false);
      i = ((1 + i) | 0)
    };
    var that = b.toList__sci_List();
    $m_sci_IndexedSeq$();
    var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
    var xs = this.f__p1__I__sci_List__sci_List(2, $as_sc_TraversableOnce($f_sc_IterableLike__zip__sc_GenIterable__scg_CanBuildFrom__O(this$6, that, bf)).toList__sci_List());
    $m_sci_List$();
    ...
    while ((!these.isEmpty__Z())) {
      ...
      var x$1 = $as_T2(arg1);
      if ((x$1.$$und2$mcZ$sp__Z() !== true)) {
        b$1.$$plus$eq__O__scm_ListBuffer(arg1)
      };
      var this$8 = these;
      these = this$8.tail__sci_List()
    };
    var this$10 = b$1.toList__sci_List();
    var f = (function(this$3$1) {
      return (function(x$2$2) {
        var x$2 = $as_T2(x$2$2);
        return x$2.$$und1$mcI$sp__I()
      })
    })(this);
    ...
    if ((bf$1 === $m_sci_List$().ReusableCBFInstance$2)) {
      ...
      var b$2 = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$10, bf$1);
      var these$1 = this$10;
      while ((!these$1.isEmpty__Z())) {
        var arg1$3 = these$1.head__O();
        b$2.$$plus$eq__O__scm_Builder(f(arg1$3));
        var this$12 = these$1;
...
$c_Lmikemcgowan_Sieve$.prototype.f__p1__I__sci_List__sci_List = (function(n, xs) {
  _f: while (true) {
    var this$1 = xs;
    var n$1 = n;
    var xs$1 = this$1;
    ...
    _loop: while (true) {
      if (xs$1.isEmpty__Z()) {
        ...
        var arg1 = xs$1.head__O();
        var t = $as_T2(arg1);
        var jsx$1 = (!(t.$$und2$mcZ$sp__Z() || (t.$$und1$mcI$sp__I() < n$1)))
      };
      if ((!jsx$1)) {
        var this$2 = xs$1;
        xs$1 = this$2.tail__sci_List();
        continue _loop
      };
      var x1 = xs$1;
      break
    ...
    if ($is_sci_$colon$colon(x1)) {
      ...
      if ((p3 !== null)) {
        var next = p3.$$und1$mcI$sp__I();
        var temp$n = ((1 + n) | 0);
        var this$4 = xs;
        var f = (function(this$2$1, next$1) {
          return (function(x0$1$2) {
            var x0$1 = $as_T2(x0$1$2);
            if ((x0$1 !== null)) {
              var a = x0$1.$$und1$mcI$sp__I();
              var p2 = x0$1.$$und2$mcZ$sp__Z();
              if (((p2 === false) && ((a > next$1) && (((a % next$1) | 0) === 0)))) {
                return new $c_s_Tuple2$mcIZ$sp().init___I__Z(a, true)
              }
            };
            return x0$1
          })
...
var $d_Lmikemcgowan_Sieve$ = new $TypeData().initClass({
  Lmikemcgowan_Sieve$: 0
}, false, "mikemcgowan.Sieve$", {
  Lmikemcgowan_Sieve$: 1,
  O: 1
});
$c_Lmikemcgowan_Sieve$.prototype.$classData = $d_Lmikemcgowan_Sieve$;
var $n_Lmikemcgowan_Sieve$ = (void 0);
function $m_Lmikemcgowan_Sieve$() {
  if ((!$n_Lmikemcgowan_Sieve$)) {
    $n_Lmikemcgowan_Sieve$ = new $c_Lmikemcgowan_Sieve$().init___()
  };
  return $n_Lmikemcgowan_Sieve$
}
/** @constructor */
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$m_Lmikemcgowan_App$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
